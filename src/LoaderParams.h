...
{
    public:
        LoaderParams(int x, int y, int width, int height, std::string textureID, int numFrames = 1, int callbackID = 0, int animSpeed = 0) 
        ...
        int getAnimSpeed() const { return m_callbackID; }
    private:
        int m_x;
        int m_y;
        int m_width;
